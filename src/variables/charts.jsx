...
const dashboardPanelChart = {
  data: canvas => {
    ...
    var chartColor = "#e7a15e";
    var gradientStroke = ctx.createLinearGradient(500, 0, 100, 0);
    gradientStroke.addColorStop(0, "#e7a15e");
    gradientStroke.addColorStop(1, chartColor);
    var gradientFill = ctx.createLinearGradient(0, 200, 0, 50);
    gradientFill.addColorStop(0, "rgba(244, 244, 244, 0)");
    gradientFill.addColorStop(1, "rgba(231, 161, 94, 0.14)");
      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: [ 400, 1500, 1000, 1900, 1300, 900, 1500, 1600, 1200, 1400, 1900, 950]
        }
      ]
    };
  },
